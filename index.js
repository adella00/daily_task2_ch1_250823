...
// note: ini saya ngerjainnya liat punyanya hafiz sama maul ya kak untuk d pelajari, otak saya lambat mencerna gak ngerti buatnya hehehe
...
contohObj.name = contohArray[28];
contohObj.age = contohArray[2];
contohObj.id = contohArray['imam'];
console.log(`ini contohObj key name dari index 2 contohArr= ${contohObj.name} `);
console.log(`ini contohObj key age dari index 3 contohArr= ${contohObj.age} `);
console.log(`ini contohObj key id dari index 1 contohArr= ${contohObj.id} `);
